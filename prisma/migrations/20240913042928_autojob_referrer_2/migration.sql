-- CreateEnum
CREATE TYPE "CardType" AS ENUM ('DAILY', 'MONTHLY', 'QUARTERLY', 'HALF_YEARLY', 'YEARLY', 'POINTS');
...
CREATE TABLE "Users" (
    ...
    "cardStartTime" TIMESTAMP(3),
    "cardEndTime" TIMESTAMP(3),
    ...
    "accountMoney" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "referrerCode" VARCHAR(50),
    "referrerTime" TIMESTAMP(3),
    "referrerVipTime" TIMESTAMP(3),
    "isVip" BOOLEAN NOT NULL DEFAULT false,
    "configJson" VARCHAR(256),

    CONSTRAINT "Users_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "ReferrerRecord" (
    "id" SERIAL NOT NULL,
    "userId" VARCHAR(64) NOT NULL,
    "points" INTEGER NOT NULL DEFAULT 0,
    ...
    CONSTRAINT "ReferrerRecord_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Users_referrerCode_key" ON "Users"("referrerCode");
...
-- CreateIndex
CREATE INDEX "ReferrerRecord_cardId_idx" ON "ReferrerRecord"("cardId");
...
-- AddForeignKey
ALTER TABLE "ReferrerRecord" ADD CONSTRAINT "ReferrerRecord_cardId_fkey" FOREIGN KEY ("cardId") REFERENCES "Cards"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
